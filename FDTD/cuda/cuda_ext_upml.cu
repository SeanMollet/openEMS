...
{
public:
	CUDA_Ext_UPML(GPU_Backend_CUDA::Impl* impl, Operator_Ext_UPML* op_ext);
...
CUDA_Ext_UPML::CUDA_Ext_UPML(GPU_Backend_CUDA::Impl* impl, Operator_Ext_UPML* op_ext)
{
	d = impl;
...
GPU_Extension* CUDA_CreateExt_UPML(GPU_Backend_CUDA::Impl* d, Engine_Extension* eng_ext, Engine* eng)
{
	...
	if (!op_ext)
		return NULL;
	return new CUDA_Ext_UPML(d, op_ext);
}
